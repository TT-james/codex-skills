...
description: Generate reusable Chinese AI推广案例 Word documents from Codex historical conversations, SpecStory history, implementation notes, Markdown, DOC/DOCX reference cases, chat logs, or code-change summaries. Use when the user explicitly asks to create, optimize, rewrite, or沉淀 an AI推广案例 / AI使用案例 Word document, especially from Codex history or a completed AI-assisted engineering task.
---
...
- Current project constraints or AGENTS.md instructions when the case is project-specific.
...
- Default output directory: place generated cases beside the source history or in a user-provided target directory. If the user gives a monthly AI case folder, use that folder.
