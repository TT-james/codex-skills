...
| [`install-github-skills`](skills/install-github-skills) | Installs, updates, lists, and removes Codex skills from a GitHub skills repository. | Keeping a local Codex skill set in sync with a shared GitHub skills repository. |
...
| [`runqian-report-tooling`](skills/runqian-report-tooling) | Inspects, extracts, edits, validates, and parameter-expands Runqian/Raqsoft RPX report dataset SQL. | Runqian report migration, dataset SQL comparison, datasource switching, mojibake repair, and RPX readback checks. |
